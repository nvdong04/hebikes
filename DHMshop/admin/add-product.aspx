<%@ Page Title="Thêm sản phẩm" Language="C#" MasterPageFile="~/admin/LayoutAdmin.Master" AutoEventWireup="true" CodeBehind="add-product.aspx.cs" Inherits="DHMshop.admin.add_product" %>
                        ...
                        <div class="col l-12 c-12 m12">
                            <%--<form action="/" method="post" enctype="multipart/form-data">--%>
                                ...
                                <div class="form-group form-btn">
                                    <asp:Button ID="btnAddProduct" runat="server" Text="Thêm" CssClass="btn btn-add-post" OnClick="btnAddProduct_Click"/>
